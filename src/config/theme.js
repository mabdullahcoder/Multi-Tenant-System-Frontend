 ...
 * 
 * This file contains all theme-related constants including colors, spacing,
...
export const shadows = {
    ...
    inner: 'inset 0 2px 4px 0 rgba(59, 130, 246, 0.06)',
    none: 'none',
};
...
// Theme preset for light blue theme
export const lightTheme = {
    background: {
        primary: colors.gray[50],
        secondary: '#ffffff',
        tertiary: colors.info[50],
    },
    text: {
    ...
    border: {
        primary: colors.info[200],
        secondary: colors.info[300],
    },
};
